...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in OrderService_pb2_grpc.py depends on'
...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateOrder = channel.unary_unary(
                ...
                response_deserializer=OrderService__pb2.CreateOrderResponse.FromString,
                _registered_method=True)
        self.GetOrder = channel.unary_unary(
                '/order.OrderService/GetOrder',
                request_serializer=OrderService__pb2.GetOrderRequest.SerializeToString,
                response_deserializer=OrderService__pb2.GetOrderResponse.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=OrderService__pb2.CreateOrderResponse.SerializeToString,
            ),
            'GetOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.GetOrder,
                    request_deserializer=OrderService__pb2.GetOrderRequest.FromString,
                    response_serializer=OrderService__pb2.GetOrderResponse.SerializeToString,
            ),
    }
...
class OrderService(object):
    ...
    def CreateOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            OrderService__pb2.CreateOrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            OrderService__pb2.GetOrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
